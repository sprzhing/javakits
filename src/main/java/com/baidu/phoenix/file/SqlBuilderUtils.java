...
public class SqlBuilderUtils {
    public static final String CSV_FILE = "/Users/zhuhongquan/laozhu/temp/upgrade_info.csv";
    ...
    public static List<String> parseFile() {
        List<String> updateCmds = new ArrayList<String>();
        List<String> lines = new ArrayList<String>();
        try {
            lines = FileUtils.readLines(new File(BONUS_FILE), "UTF-8");
        } catch (IOException e) {
